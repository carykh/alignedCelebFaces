...
alignedImages = [
["extraImages/hz_aligned.png","Henry Zhang,lol,lol"]]
...
for i in range(NEW_IMAGE_COUNT):
    imagio = misc.imread(alignedImages[i][0])
    ...
    with open(preexistingNamesFile, "a") as myfile:
        myfile.write(alignedImages[i][1]+"\n")
    print("This person has been added: "+alignedImages[i][1])
